...
Some other sources of readily available data could include:  
...
There are more difficult ways to find data, which we'll discuss in later modules:
...
Before you go much further, be sure to talk with at least a couple of advocates or experts for advice. You'll want to more about how the data was collected, whether it can answer  your questions and what other possibilities exist.
...
#### **[enigma.com](https://public.enigma.com)**

 Enigma claims to have the "world's broadest collection of public data" in a single place.  For example, looking under United States -> Arizona, you'll see a database of Arizona liquor licenses, which was scraped from the state's website two years ago.
...
You can often find individual journalists or journalism organizations in various sharing sites, including Github (which doesn't show up in default Google searches), data.world and other versioning. Look through their sites to see what they have collected -- it's there to share.  Fivethirtyeight, The Washington Post, ProPublica and the Los Angeles Times have particularly active Github and data.world repos.

#### **[Google data search](https://toolbox.google.com/datasetsearch)**

The, well, Google of data. In general, data search has limited sources and is more and more frequently logging data sets that are posted by state and local government sources.
