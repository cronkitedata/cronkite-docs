...
# Math and stat review using Excel
{: .no_toc}

Before you start, you should be sure to [read the more general math and stats refresher]({{site.baseurl}}/general/math-stats/newsroom-math) regardless of whether you're using Excel, R or something else.
